...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-info">
        <div class="container-fluid">
            <a class="navbar-brand fw-bold" href="managerInterface.php?home=true">Groot</a>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu bg-secondary" aria-labelledby="navbarDropdown">
                            <li><a class="dropdown-item myFont" href="managerInterface.php?addNewMember=true">Add New Member</a></li>
                            <li><a class="dropdown-item myFont" href="managerInterface.php?showAllUsers=true">Show All Users</a></li>
                        </ul>
                    </li>
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle  myFont" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                        ...
                        <ul class="dropdown-menu bg-secondary" aria-labelledby="navbarDropdown">
                            <li><a class="dropdown-item myFont" href="managerInterface.php?myTask=true">My Pending Task</a></li>
                            <li><a class="dropdown-item myFont" href="managerInterface.php?myCompletedTask=true">MY Completed Task</a></li>
                            <li>
                                <hr class="dropdown-divider bg-light fw-bold">
                            </li>
                            <li><a class="dropdown-item myFont" href="managerInterface.php?otherUsersTask=true">Users Pending Task</a></li>
                            <li><a class="dropdown-item myFont" href="managerInterface.php?otherUsersCompletedTask=true">Users Completed Task</a></li>
                            <li><a class="dropdown-item myFont" href="managerInterface.php?addTaskDirect=true">Assign New Task</a></li>
                        </ul>
                    </li>
                </ul>
                <ul class="navbar-nav mb-2 mb-lg-0">
                    <li class="nav-item">
                        ...
                        ?>
                        <a class="nav-link active myFont" aria-current="page" href="managerInterface.php?myDetail=true"><?php echo ucwords($userDetail['userName']); ?></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link active myFont" aria-current="page" href="managerInterface.php?logMeOut=true">Log Out</a>
                    </li>
                </ul>
            </div>
        </div>
                ...
                <div class="card mb-3" style="max-width: 540px;">
                    <div class="row g-0">
                        ...
                        <div style="text-align: center; display:inline-block" class="col-md-12 mb-3">
                            <a href="managerInterface.php?editMyInfo=true" class="btn btn-primary btn-sm fw-bold">Edit Info</a>
                            <a href="managerInterface.php?editMyPassword=true" class="btn btn-secondary btn-sm fw-bold">Edit Password</a>
                            <a href="managerInterface.php?editMyImage=true" class="btn btn-primary btn-sm fw-bold">Edit Profile Image</a>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <tbody>
                        ...
                        ?>
                                <tr>
                                    ...
                                    <td>
                                        <a class="btn btn-sm btn-info" href="managerInterface.php?editTask=<?php echo $userTaskRow['taskId'];  ?>">Edit</a>
                                        <a class="btn btn-sm btn-success" href="managerInterface.php?makeComplete=<?php echo $userTaskRow['taskId'];  ?>">Add To Complete</a>
                                        <a class="btn btn-sm btn-danger" href="managerInterface.php?deleteTask=<?php echo $userTaskRow['taskId'];  ?>" onclick="return confirmDelete()">Delete</a>
                                    </td>
                                </tr>
                    <?php endif;
                        endwhile;
                    ...
                    <tbody>
                        ...
                        ?>
                                <tr>
                                    ...
                                    <td><?php echo $userTaskRow['categoryName']; ?></td>
                                    <td>
                                        <a class="btn btn-sm btn-primary" href="managerInterface.php?reassignTask=<?php echo $userTaskRow['taskId'];  ?>">Reassign Task</a>
                                        <a class="btn btn-sm btn-danger" href="managerInterface.php?deleteTask=<?php echo $userTaskRow['taskId'];  ?>" onclick="return confirmDelete()">Delete</a>
                                    </td>
                                </tr>
                    <?php
        ...
        if (isset($_GET['otherUsersTask'])) :
            ...
            if(isset($_POST['filterTask'])){
                ...
                if(empty($filterRoleId)){
                    ...
                    JOIN workmate ON usertask.userId=workmate.userId 
                    JOIN rolecategories on workmate.roleId=rolecategories.roleId 
                    WHERE usertask.categoryId=$filterTaskCategoryId AND usertask.taskCompleted='no' AND rolecategories.roleCategory!='admin';";
                    ...
                    JOIN workmate ON usertask.userId=workmate.userId 
                    JOIN rolecategories on workmate.roleId=rolecategories.roleId 
                    WHERE workMate.roleId=$filterRoleId AND usertask.taskCompleted='no' AND rolecategories.roleCategory!='admin';";
                    $taskResult=mysqli_query($dbObj->con,$query);
                }else{
                    $query="SELECT * FROM usertask  
                    JOIN taskcategories ON usertask.categoryId=taskcategories.categoryId 
                    JOIN workmate ON usertask.userId=workmate.userId 
                    JOIN rolecategories on workmate.roleId=rolecategories.roleId 
                    WHERE usertask.categoryId=$filterTaskCategoryId AND workMate.roleId=$filterRoleId AND usertask.taskCompleted='no' AND rolecategories.roleCategory!='admin';";
                    $taskResult=mysqli_query($dbObj->con,$query);
                }
            }else{
                $query="SELECT * FROM usertask  
                ...
                JOIN workmate ON usertask.userId=workmate.userId 
                JOIN rolecategories on workmate.roleId=rolecategories.roleId
                WHERE usertask.taskCompleted='no' AND rolecategories.roleCategory!='admin';";
                $taskResult=mysqli_query($dbObj->con,$query);
            }
            $srNo = 0;
                    ...
                    <tbody>
                        ...
                        ?>
                                <tr>
                                    ...
                                    <td>
                                        <a class="btn btn-sm btn-info" href="managerInterface.php?editTask=<?php echo $taskResultRow['taskId'];  ?>">Edit</a>
                                        <a class="btn btn-sm btn-success" href="managerInterface.php?makeComplete=<?php echo $taskResultRow['taskId'];  ?>">Add To Complete</a>
                                        <a class="btn btn-sm btn-danger" href="managerInterface.php?deleteTask=<?php echo $taskResultRow['taskId'];  ?>" onclick="return confirmDelete()">Delete</a>
                                    </td>
                                </tr>
                    <?php endif;
                        endwhile;
        ...
        if (isset($_GET['otherUsersCompletedTask'])) :
            ...
            if(isset($_POST['filterTask'])){
                ...
                if(empty($filterRoleId)){
                    ...
                    JOIN workmate ON usertask.userId=workmate.userId 
                    JOIN rolecategories on workmate.roleId=rolecategories.roleId 
                    WHERE usertask.categoryId=$filterTaskCategoryId AND usertask.taskCompleted='yes' AND rolecategories.roleCategory!='admin';";
                    $taskResult=mysqli_query($dbObj->con,$query);
                }elseif(empty($filterTaskCategoryId)){
                    $query="SELECT * FROM usertask 
                    JOIN taskcategories ON usertask.categoryId=taskcategories.categoryId 
                    JOIN workmate ON usertask.userId=workmate.userId 
                    JOIN rolecategories on workmate.roleId=rolecategories.roleId 
                    WHERE workMate.roleId=$filterRoleId AND usertask.taskCompleted='yes' AND rolecategories.roleCategory!='admin';";
                    $taskResult=mysqli_query($dbObj->con,$query);
                }else{
                    $query="SELECT * FROM usertask  
                    JOIN taskcategories ON usertask.categoryId=taskcategories.categoryId 
                    JOIN workmate ON usertask.userId=workmate.userId 
                    JOIN rolecategories on workmate.roleId=rolecategories.roleId 
                    WHERE usertask.categoryId=$filterTaskCategoryId AND workMate.roleId=$filterRoleId AND usertask.taskCompleted='yes' AND rolecategories.roleCategory!='admin';";
                    $taskResult=mysqli_query($dbObj->con,$query);
                }
            }else{
                $query="SELECT * FROM usertask  
                ...
                JOIN workmate ON usertask.userId=workmate.userId 
                JOIN rolecategories on workmate.roleId=rolecategories.roleId
                WHERE usertask.taskCompleted='yes' AND rolecategories.roleCategory!='admin';";
                $taskResult=mysqli_query($dbObj->con,$query);
            }
            $srNo = 0;
        ?>
                    ...
                    <tbody>
                        ...
                        ?>
                                <tr>
                                    ...
                                    <td><?php echo ucfirst($taskResultRow['taskDisc']); ?></td>
                                    <td><?php echo ucwords($taskResultRow['categoryName']); ?></td>
                                    <td><?php echo ucwords($taskResultRow['roleCategory']); ?></td>
                                    <td>
                                        <a class="btn btn-sm btn-warning fw-bold" href="managerInterface.php?reassignTask=<?php echo $taskResultRow['taskId'];  ?>">Reassign Task</a>
                                        <a class="btn btn-sm btn-danger" href="managerInterface.php?deleteTask=<?php echo $taskResultRow['taskId'];  ?>" onclick="return confirmDelete()">Delete</a>
                                    </td>
                                </tr>
                        <?php endif;
    ...
    <div>
        ...
        if (isset($_GET['addTaskDirect'])) :
            ...
            $queryTask = "SELECT DISTINCT * FROM usertask;";
        ...
        ?>
            <form action="" class="row mt-3 " method="POST">
                <div class="col-md-2" style="margin-left: 3%;">
                    ...
                    <a class="btn btn-sm btn-primary" href="managerInterface.php?addNewTaskCategory=true">ADD NEW CATEGORY</a>
    ...
    <div class="row">
        ...
        if (isset($_GET['showAllUsers'])) :
            ...
            if(isset($_POST['filterTask'])){
                ...
                $query="SELECT * FROM workmate JOIN rolecategories on workmate.roleId=rolecategories.roleId WHERE rolecategories.roleCategory!='admin';";
                $result=mysqli_query($dbObj->con,$query);
            }
            $srNo = 0;
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                    <a class="btn btn-sm btn-info" href="managerInterface.php?editUser=<?php echo $row['userId'];  ?>">Edit</a>
                                    <a class="btn btn-sm btn-success" href="managerInterface.php?assignTask=<?php echo $row['userId'];  ?>">Assign New Task</a>
                                    <a class="btn btn-sm btn-danger" href="managerInterface.php?deleteUser=<?php echo $row['userId'];  ?>" onclick="return confirmDelete()">Delete</a>
                                </td>
                            </tr>
                    <?php endwhile;
                    endif; ?>
